...
public class MainActivity extends BaseActivity
{
    ...
    private void init(){
        ...
        miniPlayPause = (TintedImageView)findViewById(R.id.activity_main_iv_playpause);
    ...
    private void updateButtons(){
        ...
        if(aupod!=null){
            ...
            miniPlayPause.setTint(getResources().getColor(R.color.color2));
        }
        //*/
    }
